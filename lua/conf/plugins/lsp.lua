    ...
    vim.api.nvim_create_autocmd("ColorScheme", {
      callback = function()
        vim.cmd([[
          ...
          highlight DiagnosticUnderlineError gui=NONE guibg=NONE
          highlight DiagnosticUnderlineWarn  gui=NONE guibg=NONE
          highlight DiagnosticUnderlineInfo  gui=NONE guibg=NONE
